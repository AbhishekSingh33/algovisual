...
const GenericVisualizer = ({ algorithm }) => {
  switch (algorithm.category) {
    ...
    default:
      return (
        <div className="flex flex-col items-center justify-center h-[500px] bg-slate-900/50 border-2 border-dashed border-slate-800 rounded-[3rem] p-12 text-center group transition-all hover:border-indigo-500/30">
          <div className="w-24 h-24 bg-indigo-600/10 rounded-[2rem] flex items-center justify-center mb-8 border border-indigo-500/10 group-hover:scale-110 transition-transform duration-500">
